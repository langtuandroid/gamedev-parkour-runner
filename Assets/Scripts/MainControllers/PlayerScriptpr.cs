...
namespace MainControllers
{
    public class PlayerScriptpr : MonoBehaviour
    {
        ...
        {
         bool bottomRaycastHit = Physics.Raycast(raycastPositionBottom.position, transform.forward, raycastMaxDistance, environment);
         ...
         {
             onFrontWall = true;
             onFrontWallSecondary = topRaycastHit;
